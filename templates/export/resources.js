...
module.exports = {
    ...
    KendraSyncRole: {
        ...
        Properties: {
            ...
            Path: '/',
            ManagedPolicyArns: [{ Ref: 'KendraSyncPolicy' }],
        },
        Metadata: util.cfnNag(['W11', 'W12']),
    },
    KendraSyncPolicy: {
        ...
        Properties: {
            PolicyDocument: {
                Version: '2012-10-17',
                // NOSONAR TODO: split the statements up
                Statement: [
                    {
                        Effect: 'Allow',
                        Action: [
    ...
    KendraS3Role: {
        ...
        Properties: {
            ...
            Path: '/',
            ManagedPolicyArns: [{ Ref: 'KendraS3Policy' }],
        },
        Metadata: util.cfnNag(['W11', 'W12']),
    },
    TranslatePost: {
    ...
    KendraNativeCrawlerPassRole: {
        ...
        Properties: {
            ...
            Path: '/',
            Policies: [util.basicLambdaExecutionPolicy(), util.lambdaVPCAccessExecutionRole()],
            ManagedPolicyArns: [{ Ref: 'KendraNativeCrawlerPassPolicy' }],
        },
        Metadata: util.cfnNag(['W11']),
    },
                ...
                Statement: [
                    ...
                    },
                    {
                        ...
                        Resource: [
                            ...
                            {
                                'Fn::Sub':
                                    'arn:${AWS::Partition}:kendra:${AWS::Region}:${AWS::AccountId}:index/*/data-source/*',
                            },
                        ],
                    },
                    {
