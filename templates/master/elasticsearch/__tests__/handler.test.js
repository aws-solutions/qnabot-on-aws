...
const esMock = mockClient(ElasticsearchService);
...
describe('bootstrap handler', () => {
    ...
    it('should send a put request to the provided url', async () => {
        ...
        esMock.on(DescribeElasticsearchDomainCommand)
            .resolvesOnce({
                DomainStatus: {
        ...
        expect(esMock).toHaveReceivedCommandWith(DescribeElasticsearchDomainCommand, { DomainName: "test" });
