var default_settings = {
    ...
    LLM_QA_PROMPT_TEMPLATE: `{history}<br><br>Human: And here is a follow up question or statement from the human in <followUpMessage> tags:<br><followUpMessage>{input}<br></followUpMessage><br>Here are refenence passages in <references> tags:<br><references><br>{context}<br></references><br>Carefully read the references to find out if they contain information you can use to respond to the the human's follow up question or statement.<br>- If the references contain the information needed to respond, then write a friendly and confident response in under 50 words, quoting the relevant references. <br>- Else, if the answer is not explicit in the references, but you can make an informed guess, then write a friendly response in under 50 words, stating your assumptions.<br>- Else, if you cannot respond with either a confident answer on an educated guess based on the references, then reply saying "Sorry, I don't know".<br><br>Assistant: According to the context, in under 50 words: `,
...
const anthropicModelParams = `{\\"temperature\\":0, \\"modelName\\":\\"claude-instant-v1\\"}`;
module.exports = {
