var default_settings = {
    ...
    EMBEDDINGS_QUERY_PASSAGE_PREFIX_STRINGS: 'TRUE', // If TRUE, strings are prefixed by 'query: ' for questions, and 'passage: ' for answers, per https://huggingface.co/intfloat/e5-large
};
module.exports = {
