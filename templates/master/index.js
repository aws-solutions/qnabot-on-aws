...
module.exports={
  ...
  "Parameters": {
    ...
    "ElasticSearchInstanceType": {
      "Type":"String",
      "Description":"OpenSearch instance type to use for the domain. Default recommendation for production deployments is m6g.large.search (see https://aws.amazon.com/opensearch-service/pricing for other options).",
    ...
    "Encryption":{
        "Type":"String",
        "Description":"Enables encryption at rest for S3 and ElasticSearch - recommended for production deployments.",
