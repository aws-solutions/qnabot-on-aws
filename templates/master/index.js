...
module.exports = {
    ...
    Parameters: {
        ...
        LexV2BotLocaleIds: {
            Description: 'Languages for QnABot voice interaction using LexV2. Specify as a comma separated list of valid Locale IDs without empty spaces - see https://github.com/aws-solutions/aws-qnabot/blob/main/docs/multilanguage_support/README.md#supported-languages',
            Type: 'String',
