...
describe('#test_kendra_highlights()', () => {
    ...
    it('test_doc_query', async function() {
      ...
      assert.equal(resp.res.session.appContext.altMessages.ssml,
      "<speak> While I did not find an exact answer, these search results from Amazon Kendra might be helpful. The Sun is an incandescent mass of hydrogen, helium, and other heavier elements </speak>");
    });
});
