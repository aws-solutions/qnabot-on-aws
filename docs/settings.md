...
| NATIVE_LANGUAGE | text | NATIVE Language is chosen by the user during the deployment that will select which OpenSearch language analyzer to use. This will act as the primary Language whenever possible.
