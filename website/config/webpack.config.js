...
module.exports = require('../../bin/exports')(config.region).then(function(result){
    ...
    entry:{
        main:"./website/entry.js",
        check:"./website/js/browser-check.js",
        client:"./website/js/client.js",
        test:"./website/js/test.js",
    ...
    plugins:_.compact([
        ...
        extractSass,
        new CopyWebpackPlugin([{from:'./website/assets',to:"assets"}]),
        new CopyWebpackPlugin([{
            from:'./node_modules/aws-lex-web-ui/dist/wav-worker.min.js',
            to:"wav-worker.js"
        }]),
        new HtmlWebpackPlugin({
            template:'./website/html/admin.pug',
            filename:'index.html',
            chunks:["main","check","vendor"]
        }),
        new HtmlWebpackPlugin({
            template:'./website/html/test.ejs',
            filename:'test.html',
            chunks:["main","test","check"]
        }),
        new HtmlWebpackPlugin({
            template:'./website/html/client.pug',
