...
module.exports = {
    data() {
        return {
            importWarning:
                ...
                + 'formatted Excel file.  For the file format, see <a href=\'https://github.com/aws-solutions/qnabot-on-aws/tree/main/docs/excel_import#readme\' target="_blank">here</a>.',
            loading: false,
            testing: false,
            url: '',
            error: false,
    ...
    methods: {
        ...
        questionHasErrors(self, question, excelRowNumber) {
        ...
        processRow(self, question, excelRowNumber, headerMapping) {
            ...
            if (this.questionHasErrors(self, question, excelRowNumber)) {
